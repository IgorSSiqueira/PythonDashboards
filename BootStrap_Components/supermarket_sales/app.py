...
df_data = pd.read_csv('D:\Python\PythonDashboards\BootStrap_Components\supermarket_sales\supermarketsales.csv')
...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                html.H2('Good Price', style={'font-family': 'Voltaire', 'font-size': '30px'}),
                html.H5('Cidades:'),
                dcc.Checklist(
                ...
                html.H5('Variáveis de análise:', style={'margin-top': '30px'}),
        ...
        dbc.Col([
            ...
            dbc.Row([dcc.Graph(id='income_perdate_fig')]),
...
@app.callback([
    ...
    Output('income_perdate_fig', 'figure'),
