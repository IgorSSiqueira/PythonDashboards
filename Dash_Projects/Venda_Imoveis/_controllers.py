...
controllers = dbc.Row([
    html.Img(id='logo', src=app.get_asset_url('DashPlotly.png'), style={'width': '50%'}),
    html.H3('Vendas de imóveis - NYC', style={'margin-top': '10px'}),
    html.P('''Utilize este dashboard para analisar as vendas ocorridas na 
            cidade de New York no período de 1 ano.'''),
    html.H4('''Distrito''', style={'margin-top': '50px', 'margin-bottom': '50px'}),
    dcc.Dropdown(
